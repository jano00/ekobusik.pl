...
<head>
    ...
    <meta name='description' content='Przejażdżki Eko-Busikami dla grup zorganizowanych i wycieczek szkolnych po Kazimierzu Dolnym. Zapraszamy do zapoznania się z najciekawszymi trasami. Tylko u nas specjalne PROMOCJE dla grup :)' />
    <meta name='keywords' content='wycieczki melexami, zwiedzanie, pojazd, elektryczny' />
...
<body>
    ...
    <section class="main-banner">
        <div class="background">
            ...
            <h2 class="title-description">
                Zapoznaj się z naszymi trasami dla grup zorganizowanych i wycieczek szkolnych!
            </h2>
            <hr>
            <p>
                Dla grup od 15 do 156 osób przygotowaliśmy specjalne trasy w promocyjnych cenach, w tym najdłuższą trwającą ponad 2 godziny!
                Standardowo zaczynamy wycieczkę z Dużego Rynku, ale możemy też odebrać Państwa z parkingu dla autokarów. W przypadku grup szkolnych na każdy pojazd (13 pasażerów) jeden opiekun gratis oraz darmowy przejazd dla pilota i kierowcy autokaru :)
            </p>
        </div>
    </section>
    ...
    <section class="road">
        ...
        <div class="img-box">
            <img alt="" class="map" src="images/maps/road1.JPG">
        </div>
        <div class="road-info">
            <div class="background">
                <div class="wrap">
                    ...
                    <div>Czas trasy:<span class="yellow"> 55 - 60 min</span></div>
                </div>
                <div class="wrap">
                    <div><span class="yellow"> Cena:</span></div>
                    <div>dzieci <span class="yellow">9 zł</span></div>
    ...
    <section class="road-left">
        ...
        <div class="img-box">
            <img alt="" class="map" src="images/maps/road2.JPG">
        </div>
        <div class="road-info">
            <div class="background">
                <div class="wrap">
                    <div>Długość: <span class="yellow"> 6 km</span></div>
        ...
        <div class="road-info">
            <div class="background">
                <div class="wrap">
                    ...
                    <div>Liczba przystanków:<span class="yellow"> 2</span></div>
                    <div>Czas:<span class="yellow"> 1 godz. 15-20 min</span></div>
                </div>
                <div class="wrap">
                    <div><span class="yellow"> Cena:</span></div>
                    <div>dzieci <span class="yellow">12 zł</span></div>
                    <div>dorośli <span class="yellow">15 zł</span></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="road-left">
        ...
        <div class="img-box">
            <img alt="" class="map" src="images/maps/road3.JPG">
        </div>
        <div class="road-info">
            <div class="background">
                <div class="wrap">
                    <div>Długość: <span class="yellow">17 km</span></div>
                    <div>Liczba przystanków:<span class="yellow"> 3</span></div>
                    <div>Czas:<span class="yellow"> 2 godz. 10-20 min</span></div>
                </div>
                <div class="wrap">
                    <div><span class="yellow"> Cena:</span></div>
                    <div>dzieci <span class="yellow">24 zł</span></div>
                    <div>dorośli <span class="yellow">32 zł</span></div>
                </div>
            </div>
        </div>
    </section>
